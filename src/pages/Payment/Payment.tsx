            ...
            transition-shadow'
				...
				<div className='flex-1 bg-gray-200 p-4'>
					...
					>
						...
						{showSelect && (
							<div>
								...
								>
									<SelectTrigger
										className='w-[150px] cursor-pointer rounded-sm border-0 px-4 py-1 shadow-[3px_3px_5px_rgba(255,255,255,0.7),inset_2px_2px_3px_rgba(189,194,199,0.75)] focus:outline-none mr-12'
										style={{
											...FONTS.para_02,
                  ...
                  `}
					...
					{/* Filter Button */}
					<div className='flex lg:absolute lg:right-14 lg:top-34 items-center gap-3 mt-4 lg:mt-0 justify-end lg:justify-start'>
						<img
							src={filImg}
							alt='filter'
