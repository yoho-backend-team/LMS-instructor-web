		...
		>
            ...
            `,
                ...
                `,
						...
						<p
							className='text-center my-1 text-sm sm:text-base md:text-lg lg:text-xl'
						...
						<form onSubmit={handleSubmit(onSubmit)} className='w-full my-4 '>
							...
							<button
								...
								disabled={isLoading}
								className='w-full my-6 mt-8 py-2 rounded-md transition cursor-pointer flex items-center justify-center gap-2 text-sm sm:text-base lg:text-lg shadow-[3px_3px_5px_rgba(255,255,255,0.7),inset_2px_2px_3px_rgba(189,194,199,0.75)] hover:shadow-[inset_3px_3px_5px_rgba(123,0,255,0.3),inset_-3px_-3px_5px_rgba(255,255,255,0.7)] disabled:opacity-50 disabled:cursor-not-allowed'
								style={{
									...FONTS.heading_04,
									color: COLORS.white,
