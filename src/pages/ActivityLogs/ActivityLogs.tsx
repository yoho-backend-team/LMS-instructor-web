...
const ActivityLogs = () => {
	...
	const activityLogs = [
		...
		{ id: 5, title: 'Marked Attendance', date: '30 June 2025 3:30 PM', description: 'Recorded attendance for HTML & CSS lecture' },
		{ id: 6, title: 'Updated Assignment', date: '30 June 2025 2:55 PM', description: 'Modified deadline for Research Paper' },
		{ id: 7, title: 'Failed Login Attempt', date: '30 June 2025 1:45 PM', description: 'Failed login with incorrect password' },
		{ id: 8, title: 'Logged in from New Device', date: '30 June 2025 5:45 PM', description: 'First login from new MacBook Pro' },
		{ id: 9, title: 'Group Message Sent', date: '30 June 2025 6:45 PM', description: 'Sent message to all students in MERN' },
		{ id: 10, title: 'Downloaded Materials', date: '30 June 2025 1:45 PM', description: 'Downloaded lecture slides for offline use' },
	];
					...
					<div className='flex justify-center gap-3 mt-6'>
						{Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
							<button
								...
								className={`h-10 w-10 rounded-full flex items-center justify-center font-semibold text-sm transition-all duration-200
									${
										currentPage === page
											? 'bg-gradient-to-r from-[#7B00FF] to-[#B200FF] text-white shadow-md scale-105'
											: 'bg-[#ebeff3] text-black hover:bg-gray-200'
									}`}
								style={{
									boxShadow:
										currentPage === page
											? '0 4px 6px rgba(0,0,0,0.1)'
											: '2px 2px 4px rgba(189,194,199,0.75)',
								}}
							>
								{page}
							</button>
