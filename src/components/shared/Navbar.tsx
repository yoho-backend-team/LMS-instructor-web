	...
	return (
		<nav>
			<div className='flex justify-between gap-3 px-6'>
				{/* Institute Logo with Tooltip */}
				<Tooltip content={dashData?.institute?.institute_name || 'Home'} position="bottom">
					<Card
				...
				<div className='flex gap-6'>
	              ...
	              `,
					...
					<Tooltip content={dashData?.user?.full_name || 'Profile Menu'} position="bottom">
						<div
							className='cursor-pointer'
	            ...
	            `,
						...
						>
							...
							<Tooltip content="Logout from account" position="left">
								<Button
