...
const StudyMaterials = ({ setselectedNotes }: StudyMaterialsProps) => {
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <div className={`w-10 h-10 bg-gradient-to-r ${getFileTypeInfo(material?.file).color} rounded-full flex items-center justify-center`}>
