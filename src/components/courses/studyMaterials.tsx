        ...
        <div className="flex flex-col">
          <Card className="bg-gradient-to-r from-[#7B00FF] to-[#B200FF] text-white p-6 sticky top-0 z-10 ml-4 mr-4 mb-4">
            <div className="grid grid-cols-4 gap-4">
              <div className="text-center !text-white" style={{ ...FONTS.heading_02 }}>
                File
              </div>
              <div className="text-center !text-white" style={{ ...FONTS.heading_02 }}>
                Name
          ...
          >
            {courseSelectData?.studymaterials?.map((material: any, index: number) => (
              <Card
                key={index}
              ...
              >
                <div className="grid grid-cols-4 gap-4 items-center">
                  ...
                  <div className="text-center !text-gray-600" style={{ ...FONTS.heading_07 }}>
                    {material?.title}
                  </div>
                  <div className="text-center !text-gray-600" style={{ ...FONTS.heading_07 }}>{formattedDate(material?.updatedAt)}</div>
                  <div className="flex justify-center">
                    <Button className="bg-[#EBEFF3] p-2 w-15 h-12 hover:bg-[#EBEFF3] shadow-[5px_5px_4px_rgba(255,255,255,0.7),2px_2px_3px_rgba(189,194,199,0.75)_inset]" variant="outline">
                      <img src={Edit} className="w-5 h-6" alt="Edit" />
                    </Button>
                    <Button className="bg-[#EBEFF3] w-15 h-12 ml-2 hover:bg-[#EBEFF3] shadow-[5px_5px_4px_rgba(255,255,255,0.7),2px_2px_3px_rgba(189,194,199,0.75)_inset]" variant="outline">
                      <img src={Trash} className="w-5 h-6" alt="Delete" />
                    </Button>
                  </div>
                </div>
              </Card>
