...
const FileUploadDesign = React.memo(
	({ selectedNotes, activeTab, onRefresh }: FileUploadDesignProps) => {
				...
				if (selectedNotes == null) {
					...
					try {
						...
						if (response) {
							...
							toast.error('Failed to update the study material, please try again.');
						}
					} catch (error) {
						console.warn(error);
						toast.error('Something went wrong, please try again.');
