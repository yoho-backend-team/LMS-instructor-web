...
const FileUploadDesign = () => {
  return (
    <div className="w-full h-screen  mx-auto p-6   shadow-lg   rounded-lg mt-25 shadow-[-4px_-4px_4px_rgba(255,255,255,0.7),_5px_5px_4px_rgba(189,194,199,0.75)] p-6">
      {/* Heading Section */}
      <div className="mb-6">
      ...
      <div className="mb-6">
        ...
        {/* Drop Zone */}
        <div className="border-2 border-dashed border-gray-300 rounded-lg shadow-lg btnshadow p-8 text-center">
          <img src={fileimg} className="w-6 h-6 ml-[260px]"/>
