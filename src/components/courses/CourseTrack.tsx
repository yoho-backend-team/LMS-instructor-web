    ...
    <div className="w-full p-6">
      <div className="flex justify-between">
        ...
        <div>
          <h1>
            Batch Name:{" "}
            <span style={{ ...FONTS.heading_02 }}>
              {SelectBatches?.batch_name}
            </span>
          </h1>
        </div>
      </div>
                ...
                >
                  <div className="grid grid-cols-3 gap-4 text-center items-center">
                    ...
                    >
                      <Select
                        onValueChange={(value) =>
                          updateModuleStatus(item?._id, value)
                        }
      ...
      ${
        item?.status === "in-progress"
          ? "bg-orange-100 text-orange-700 border-orange-400 cursor-pointer"
          : ""
      }
      ${
        item?.status === "not-started"
          ? "bg-red-100 text-red-700 border-red-400 cursor-pointer"
          : ""
      }
    `}
                        >
