				...
				{selectedChat ? (
					<>
						<div className='p-3 bg-[#EBEFF3] rounded-lg overflow-hidden shadow-[-4px_-4px_4px_rgba(255,255,255,0.7),_5px_5px_4px_rgba(189,194,199,0.75)] transition-all cursor-pointer flex flex-col h-[75vh]'>
							...
							{/* Scrollable message area with fixed background */}
							<div className='relative flex-1 rounded-md overflow-hidden min-h-0'>
								...
								<div className='relative z-10 overflow-y-auto px-2 py-1 h-full'>
									{messages?.length ? (
										<MessageList
											messages={messages}
											formatMessageDate={formatMessageDate}
