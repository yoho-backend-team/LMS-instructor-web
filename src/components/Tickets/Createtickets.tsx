...
import { createticketdata, uploadticketfile } from '@/features/Tickets/services/Ticket';
...
export const Createtickets = () => {
  ...
  const userid =  GetLocalStorage("instructorDetails")
  console.log(userid,"sowmiyaid")
